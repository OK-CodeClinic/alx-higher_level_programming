...
1. Control Flow
2. Indentation Error
3. How To Use String Formatters in Python 3
4. String Exception and Handling
5. String Functions
6. Looping
7. Pycodestyle – Style Guide for Python Code

#### Also, To proceed with this task, You must learn the following;
...
All code must obey Pycodestyle -- is now the new standard of Python style code
