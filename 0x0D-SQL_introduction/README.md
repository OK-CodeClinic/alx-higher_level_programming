# SQL   -- Introduction
In this project im started learning about what is SQL, And its basic. I learned;
...
* **11. Select the best**
  * [11-best_score.sql](./11-best_score.sql): MySQL script that lists the `score` and `name` of all
         records with a `score >= 10` in the table          `se      cond_table` in order of descending score.
